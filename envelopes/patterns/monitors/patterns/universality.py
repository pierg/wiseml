...
from envelopes.patterns.monitors.safetystatemachine import SafetyStateMachine
...
class Universality(SafetyStateMachine):
    ...
    def __init__(self, name, conditions, notify, rewards, perception, context):
        ...
        super().__init__(name, "universality", self.states, self.transitions, 'idle', notify, perception, context)
    ...
    def _map_conditions(self, action_proposed):
        condition = self.perception.is_condition_satisfied(self.condition, action_proposed)
