...
class RandomEnv(ExMiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        #Place lightswitch
        width_pos = random.randint(2,7-5) # x position of the light switch (2 tiles space for each room)
        height_pos = random.randint(2,7-2) # y position of light switch (needs space for the wall and door)
...
class RandomEnv7x7_6748(RandomEnv):
    def __init__(self):
        super().__init__(size=7)

register(
    id='MiniGrid-RandomEnv-7x7-6748-v0',
    entry_point='gym_minigrid.envs:RandomEnv7x7_6748'
)
